...
import saver.BroadcastSaveLoad;
import saver.LeadHostSaver;
...
public class Main {
    ...
    private void run() {
        ...
        BroadcastSaveLoad save = new BroadcastSaveLoad(broadcastList);
        save.loadBroadcast();
        LeadHostSaver leadHostSaver = new LeadHostSaver(leadHostList);
        leadHostSaver.printLeadHost();
    }
}